...
commands = [
    ...
    {
        "description": "Executando cliente TCP local diretamente (sem Docker) para enviar 10 requisições INFO ao servidor local (127.0.0.1:8080) com modo detalhado (verbose), salvando logs em performance.log e resultados em resultados_linux.csv.",
        "command": "python3 main_script.py --script tcp-client/tcp-client.py --host 127.0.0.1 --port 8080 --requests 10 --command INFO --log performance.log --verbose True --keep 1 --output_file resultados_linux.csv",
    },
    {
        "description": "Executando cliente TCP local diretamente (sem Docker) para enviar 10 requisições INFO ao servidor local (127.0.0.1:8080), salvando logs em performance.log e resultados em resultados_linux.csv.",
        "command": "python3 main_script.py --script tcp-client/tcp-client.py --host 127.0.0.1 --port 8080 --requests 10 --command INFO --log performance.log  --keep 0 --output_file resultados_linux.csv",
    },
    {
        "description": "Executando cliente TCP local diretamente (sem Docker) para enviar 10 requisições INFO ao servidor local (127.0.0.1:8080) com modo detalhado (verbose), salvando logs em performance.log e resultados em resultados_linux.csv.",
        "command": "python3 main_script.py --script tcp-client/tcp-client.py --host 127.0.0.1 --port 8080 --requests 10 --command INFO --log performance.log   --keep 1 --output_file resultados_linux.csv",
    },
]
